defmodule NookBook.ACNH.Cache do
  ...
  defmodule Private do
    ...
    def list_from_cache(namespace, function) do
      # Careful here.. some inconsistency can happen if you have a value, or if the response is an empty list
      with [] <- Cache.filter({namespace, :_}) do
    ...
    def record_from_cache(namespace, function, id) do
      with nil <- Cache.get({namespace, id}) do
